...
#### 9. 换肤功能
		我司在 App 中增加了一个换肤的功能, 当初就是用的 runtime + RAC 实现的,
		说下大概实现的方法, 重写所有和 UI 有关的系统方法,  比如 UIview 的 setBackgroundColor 的方法,  UILabel 的 setTitltColor 的方法, 在皮肤发生变化的时候, 重新去颜色表中读取颜色, UI 重新布局
